...
- Dynamic quiz system with randomly generated questions  
- Asynchronous data loading using fetch (AJAX) from a JSON file  
- Real-time score calculation with pass/fail feedback  
...
This application uses asynchronous requests (fetch/AJAX) to load quiz data from:
